<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="form-group{{ $errors->has('img_name') ? ' has-error' : '' }}" style="margin-bottom: 0;">
            <div class="form-line">
        ...
        <a href="{!! route('partners.catalogs.products.index') !!}" class="btn btn-primary waves-effect">CANCEL</a>
    </div>
</div>