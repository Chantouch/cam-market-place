        ...
        <table class="table table-hover">
            ...
            @foreach($products as $index => $product)
                <tr class="remove">
                    ...
                    <td>
                        {!! Form::open(['route' => ['partners.catalogs.products.destroy', $product->hashid], 'method' => 'delete', 'class'=>'form-product-fix']) !!}
                        <a href="{!! route('partners.catalogs.products.edit', [$product->hashid]) !!}"
                        ...
                        <ul class="dropdown-header m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li>
                                        <a href="{!! route('partners.catalogs.products.duplicate', [$product->hashid]) !!}"
                                           class='btn btn-default btn-xs'>
                                            <i class="material-icons">content_copy</i> Duplicate
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{!! route('partners.catalogs.products.show', [$product->hashid]) !!}"
                                           class='btn btn-default btn-xs'>
