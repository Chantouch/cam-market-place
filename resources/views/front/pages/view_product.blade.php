            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="breadcrumb">
                        ...
                        <a class="hidden-xs" title="Automotive &amp; Motorcycle" href="index.html">Automotive &amp; Motorcycle</a>
                        ...
                        <div id="content-eleyas">
                            <div id="my-tab-content" class="tab-content">
                                <div class="tab-pane active" id="view1">
                                    ...
                                    <a class="fancybox" href="img/single-product/faded-short-sleeves-tshirt1.jpg" data-fancybox-group="gallery" title="">
                            ...
                            <div id="viewproduct" class="nav nav-tabs product-view owl-carousel owl-theme" data-tabs="tabs" style="opacity: 1; display: block;">
                                <div class="owl-wrapper-outer">
                                    <div class="owl-wrapper" style="width: 920px; left: 0px; display: block; transition: all 1000ms ease; transform: translate3d(0px, 0px, 0px);">
                                        <div class="owl-item" style="width: 92px;">
                                            <div class="pro-view active"><a href="#view1" data-toggle="tab"><img src="img/single-product/faded-short-sleeves-tshirt1m.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="owl-item" style="width: 92px;">
                                            <div class="pro-view"><a href="#view2" data-toggle="tab"><img src="img/single-product/faded-short-sleeves-tshirt2m.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        <div class="owl-item" style="width: 92px;">
                                            <div class="pro-view"><a href="#view3" data-toggle="tab"><img src="img/single-product/faded-short-sleeves-tshirt3m.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="owl-item" style="width: 92px;">
                                            <div class="pro-view"><a href="#view4" data-toggle="tab"><img src="img/single-product/faded-short-sleeves-tshirt4m.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="owl-item" style="width: 92px;">
                                            <div class="pro-view"><a href="#view5" data-toggle="tab"><img src="img/single-product/printed-chiffon-dress.jpg" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="my-tab-content-2" class="tab-content">
                            ...
                            <div class="tab-pane" id="info3">
                                <div class="tab-info-product owl-carousel owl-theme" style="opacity: 0; display: block;">
                                    <!-- Start featured item -->
                                    <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 300px; left: 0px; display: block; transition: all 0ms ease; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 25px;"><div class="featured-inner">
            ...
            <div class="row">
                ...
                <div class="featured-product">
                    <div class="featured-item owl-carousel owl-theme" style="opacity: 1; display: block;">
                        <!-- Start featured item -->
                        <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 7956px; left: 0px; display: block; transition: all 0ms ease; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 234px;"><div class="col-sm-3">
                        ...
                        <div class="owl-item" style="width: 234px;"><div class="col-xs-12 col-sm-3">
                            <div class="featured-inner">
                                <div class="featured-image">
                                    <a href="single-product.html">
                        ...
                        <div class="owl-controls clickable">
                            <div class="owl-buttons">
                                <div class="owl-prev"><i class="icon-left-open"><i class="fa fa-angle-left"></i></i></div>
                                <div class="owl-next"><i class="icon-right-open"><i class="fa fa-angle-right"></i></i></div>
                            </div>
                        </div>
                    </div>
                </div>
